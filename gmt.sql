...
-- Dumping structure for table gmt.gm_ballrace
...
-- Dumping data for table gmt.gm_ballrace: ~0 rows (approximately)

-- Dumping structure for table gmt.gm_bans
...
-- Dumping data for table gmt.gm_bans: ~0 rows (approximately)

-- Dumping structure for table gmt.gm_casino
CREATE TABLE IF NOT EXISTS `gm_casino` (
  `type` tinytext NOT NULL,
  `jackpot` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table gmt.gm_casino: ~2 rows (approximately)
INSERT INTO `gm_casino` (`type`, `jackpot`) VALUES
	('slots', 5000),
	('slots', 1000),
	('slots', 750),
	('slots', 250),
...
-- Dumping structure for table gmt.gm_chat
...
-- Dumping data for table gmt.gm_chat: ~0 rows (approximately)

-- Dumping structure for table gmt.gm_gomap
...
-- Dumping data for table gmt.gm_gomap: ~0 rows (approximately)

-- Dumping structure for table gmt.gm_hackers
CREATE TABLE IF NOT EXISTS `gm_hackers` (
  `steamid` tinytext DEFAULT NULL,
  `name` tinytext DEFAULT NULL,
  `hackid` tinyint(4) DEFAULT NULL,
  `cmd` tinytext DEFAULT NULL,
  `args` tinytext DEFAULT NULL,
  `extra` tinytext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table gmt.gm_hackers: ~0 rows (approximately)
...
-- Dumping data for table gmt.gm_hats: ~0 rows (approximately)

-- Dumping structure for table gmt.gm_items
...
-- Dumping data for table gmt.gm_items: ~710 rows (approximately)
...
-- Dumping structure for table gmt.gm_jeopardy
...
-- Dumping data for table gmt.gm_jeopardy: 107 rows
/*!40000 ALTER TABLE `gm_jeopardy` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `gm_jeopardy` ENABLE KEYS */;

-- Dumping structure for table gmt.gm_loading
CREATE TABLE IF NOT EXISTS `gm_loading` (
  `gamemode` tinytext NOT NULL,
  `steamids` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table gmt.gm_loading: ~8 rows (approximately)
...
-- Dumping structure for table gmt.gm_log
...
-- Dumping data for table gmt.gm_log: ~0 rows (approximately)

-- Dumping structure for table gmt.gm_log_error
CREATE TABLE IF NOT EXISTS `gm_log_error` (
  `srvid` int(11) NOT NULL,
  `message` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- Dumping data for table gmt.gm_log_error: ~0 rows (approximately)

-- Dumping structure for table gmt.gm_log_trade
...
-- Dumping data for table gmt.gm_log_trade: 0 rows
/*!40000 ALTER TABLE `gm_log_trade` DISABLE KEYS */;
/*!40000 ALTER TABLE `gm_log_trade` ENABLE KEYS */;

-- Dumping structure for table gmt.gm_maps
...
-- Dumping data for table gmt.gm_maps: ~95 rows (approximately)
INSERT INTO `gm_maps` (`map`, `mapname`, `desc`, `author`, `gamemode`, `playedCount`, `dateAdded`, `dateModified`) VALUES
	('gmt_ballracer_facile', 'Facile', 'A simplisic, but extremely difficult world. Avoid repellers in space, or go full hyperspeed while magnetized.', 'Bumpy', 'ballrace', 0, 1339137397, 1339252668),
	...
	('gmt_ballracer_metalworld', 'Metal World', 'Hard levels in a world made of metal, also introducing new objects such as crushers, lava and gears.', 'Bumpy', 'ballrace', 0, 1339137397, 1339252668),
	...
	('gmt_ballracer_nightball', 'Night World', 'Roll through this gravity defying world with moving obstacles, lasers, and lots of speed!', 'Bumpy', 'ballrace', 0, 1339137397, 1339252668),
	...
	('gmt_ballracer_spaceworld01', 'Space World', 'Hard, more dynamic levels with new obstacles such as a catapult.', 'Bumpy', 'ballrace', 0, 1339137397, 1339252668),
	('gmt_ballracer_tranquil01', 'Tranquil', 'A magical world full of... RAINBOWS!', 'Bumpy', 'ballrace', 0, 1339137397, 1339252668),
	('gmt_ballracer_waterworld02', 'Water World', 'Meet water physics in this fun, fast paced world. Float, dive and bounce to victory!', 'Bumpy', 'ballrace', 0, 1339137397, 1339252668),
	...
	('gmt_build0h3_games', '∟∟∟∟∟∟∟', '????????????', '', 'gmtlobby', 0, 1249150914, 1249150914),
	...
	('gmt_build0s3a', 'Summer \'23 Lobby', 'For the first time in 9 years, the Lobby has been given a look over by our maintenance staff! Take a look around and explore all the new sights, plus a few new secrets!', 'PixelTail Games / TCF Team', 'gmtlobby', 0, 1399590414, 1399590414),
	...
	('gmt_lobby2_r7c', '[Christmas] Lobby 2 - Deluxe', 'Happy holidays from GMod Tower: Deluxe! A snowy version of Lobby filled with holiday goodness. Take a breather and walk outside and hang around the heated pool. Buy exclusive holiday items located in the present sack.', 'PixelTail Games / GMT: Deluxe Team', 'gmtlobby', 0, 1399590414, 1399590414),
	('gmt_lobby2_r7h', '[Halloween] Lobby 2 - Deluxe', 'A spooky version of the Lobby. Search for Candy Buckets around the Plaza and drop them off at the cauldron for special Halloween items! Feeling lucky? Try our new prize wheel "Spin or Treat".', 'PixelTail Games / GMT: Deluxe Team', 'gmtlobby', 0, 1399590414, 1399590414),
	...
	('gmt_pvp_mars', 'Mars', 'A small group of survivors were discovered living in a secret military base. They were also found to be endlessly shooting each other and respawning.', 'Bumpy', 'pvpbattle', 0, 1249150914, 1249150914),
...
-- Dumping structure for table gmt.gm_name_suggestions
...
-- Dumping data for table gmt.gm_name_suggestions: ~0 rows (approximately)

-- Dumping structure for table gmt.gm_servers
...
-- Dumping data for table gmt.gm_servers: ~9 rows (approximately)
INSERT INTO `gm_servers` (`id`, `ip`, `port`, `players`, `playerlist`, `msg`, `maxplayers`, `map`, `password`, `gamemode`, `status`, `lastupdate`, `lastplayers`) VALUES
	(4, '127.0.0.1', '27017', '0', '', '#nogame', '16', 'gmt_ballracer_grassworld01', '', 'ballrace', '1', '1693003577', '\0'),
	(5, '127.0.0.1', '27017', '0', '', '#nogame', '16', 'gmt_pvp_frostbite01', '', 'pvpbattle', '1', '1693005761', '\0'),
	(6, '127.0.0.1', '27017', '0', '\0', '#nogame', '16', 'gmt_virus_aztec01', '', 'virus', '1', '1693007818', '\0'),
	(7, '127.0.0.1', '27017', '0', '', '#nogame', '16', 'gmt_uch_headquarters03', '', 'ultimatechimerahunt', '1', '1693007521', '\0'),
	(8, '127.0.0.1', '27017', '0', '\0', '#nogame', '16', 'gmt_zm_arena_gasoline01', '', 'zombiemassacre', '1', '1693007646', '\0'),
	(14, '127.0.0.1', '27017', '0', '\0', '#nogame', '16', 'gmt_minigolf_forest04', '', 'minigolf', '1', '1693002402', '\0'),
	(16, '127.0.0.1', '27017', '0', '', '#nogame', '16', 'gmt_sk_lifelessraceway01', '', 'sourcekarts', '1', '1693005667', '\0'),
	(20, '127.0.0.1', '27070', '0', '\0', '#nogame', '8', 'gmt_gr_ruins', '', 'gourmetrace', '1', '1626072854', '\0'),
	(99, '127.0.0.1', '27015', '0', '\0', '', '64', 'gmt_build0s3a', '', 'gmtlobby', '1', '1693013992', '');

-- Dumping structure for table gmt.gm_users
CREATE TABLE IF NOT EXISTS `gm_users` (
  `id` text NOT NULL,
  `name` text NOT NULL,
  `steamid` text NOT NULL,
  `betatest` varchar(45) DEFAULT NULL,
...
-- Dumping data for table gmt.gm_users: ~0 rows (approximately)
...
-- Dumping data for table gmt.gm_vip: ~0 rows (approximately)
